      ...
      <div className="footer__wrapper">
        <div className="footer__main">
          <div className="footer__brand">
            ...
            <p className="footer__tagline">
              Sanación, aromaterapia y limpieza energética. Productos artesanales importados desde México, Perú y Argentina.
            </p>
          </div>

          <nav className="footer__nav">
            <a href="#" className="footer__nav-link">Inicio</a>
            <a href="#" className="footer__nav-link">Tienda</a>
            <a href="#" className="footer__nav-link">Sobre Nosotros</a>
            <a href="#" className="footer__nav-link">Ofertas</a>
            <a href="#" className="footer__nav-link">Contacto/ Mayoristas</a>
          </nav>
        </div>
        ...
        <div className="footer__bottom">
          <span className="footer__copyright">
            &copy; 2024 Adikari. Powered by Shopify
          </span>

          <span className="footer__legal">
            <a href="#" className="footer__legal-link">Términos y políticas</a>
          </span>
